...
def part1():
    ...
    aux = []
    for blueprint in blue_prints:
        aux.append( get_max_geode( blueprint, 24 ) )
        print(aux[-1])

    print("part 1: {}".format(sum(aux)))
...
def part2():
    ...
    l = []
    for blue_print in blue_prints[ : min(3, len(blue_prints)-1)]:
        l.append( get_max_geode( blue_print, 32 ) )
        print(l[-1])
